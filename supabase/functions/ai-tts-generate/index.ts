...
serve(wrapMindManualSubjectHandler("ai-tts-generate", verifiedBearerMindManualScope("authenticated_request"), async (req) => {
  ...
  try {
    ...
    const response = await fetch('https://api.openai.com/v1/audio/speech', {
      ...
      body: JSON.stringify({
        model: 'tts-1-hd', // Use tts-1-hd for better speed control and quality
        input: text,
        voice: selectedVoice,
        response_format: 'mp3',
        speed: 1.0,
