...
serve(wrapMindManualSubjectHandler("plaid-get-transactions", verifiedBearerMindManualScope("authenticated_request"),
  (request, _lifecycle, context) => handlePlaidUserSync(request, context.userId, runtime, "transactions")));
