...
serve(wrapMindManualSubjectHandler("ai-voice-transcribe", verifiedBearerMindManualScope("authenticated_request"), async (req) => {
  ...
  try {
    ...
    return new Response(
      JSON.stringify({ 
        ...
        because: 'Transcribed using OpenAI Whisper with privacy protection'
      }),
