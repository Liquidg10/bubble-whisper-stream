...
This continues the opt-in motion, stable controls and reviewed suggestions described in `molecule-interaction-research.md`. Participant testing and physical-device testing remain separate future work. Saved layout and optional spatial 3D are documented in `saved-spatial-layouts.md`.
